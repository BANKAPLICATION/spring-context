...
public class FightClubImpl implements FightClub {
    ...
    public void fight() {
        ...
        if (loriStrength > baxterStrength) System.out.println(loriName + " cat win");
        else if(baxterStrength > loriStrength) System.out.println(baxterName + " cat win");
        else System.out.println("Cats strengts is the same");
    }
